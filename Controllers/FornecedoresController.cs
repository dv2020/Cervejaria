...
namespace Cervejaria.Controllers
{
    ...
    public class FornecedoresController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "FornecedorId,Nome,CNPJ")] Fornecedor fornecedor)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "FornecedorId,Nome,CNPJ")] Fornecedor fornecedor)
        {
            if (ModelState.IsValid)
            {
